    ...
    <div style="">
        ...
        <div style="width:100svw; height:100svh; position:relative; overflow-y:auto;">
            ...
            <template v-if="!isNarrow">
                <a href="https://github.com/yuda-lyu/w-echarts-vue" class="github-corner" style="position:fixed; top:0; right:0; border:0; z-index:10000;" aria-label="View source on GitHub" target="_blank" rel="noreferrer noopener">
            ...
            <div style="width:100%;">
                ...
                <AppZoneWEchartsVue v-if="cmpPick==='WEchartsVue'"></AppZoneWEchartsVue>
...
import AppZoneWEchartsVue from './AppZoneWEchartsVue.vue'
...
export default {
    ...
    mounted: function() {
        ...
        //urlParse, http://localhost:8080/?cmp=w-echarts-vue
