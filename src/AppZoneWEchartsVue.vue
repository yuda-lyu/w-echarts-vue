<template>
    <div class="bkh">
        ...
        <div class="head1"><span style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('//yuda-lyu.github.io/w-echarts-vue/examples/app.html?cmp='+this.innerText,'_blank')">w-echarts-vue</span></div>


        <div style="font-size:0.9rem; margin-bottom:10px;">
            <span style="margin-right:10px;">Links:</span>
            <a href="//github.com/apache/echarts" target="_blank" rel="noreferrer noopener">echarts</a>
            <span style="margin:0px 10px">|</span>
            <a href="//echarts.apache.org/examples/zh/index.html" target="_blank" rel="noreferrer noopener">echarts examples</a>
            <span style="margin:0px 10px">|</span>
            <a href="//github.com/ecomfe/echarts-gl" target="_blank" rel="noreferrer noopener">echarts-gl</a>
        </div>
        ...
        <div>
            ...
            <div class="bk">
                <demolink
                    :pkgname="'w-echarts-vue'"
                    :kbname="'w-echarts-vue'"
                    :casename="'line'"
                ></demolink>

                <w-echarts-vue
                    style="width:620px; height:300px;"
                    :options="WEchartsVue.options1"
                ></w-echarts-vue>
            ...
            <div class="bk">
                ...
                <div style="padding-bottom:10px;">
                    <span class="cpitem cpitem-white" style="display:inline-block; margin:0px 10px 5px 0px; border:1px solid #ddd; border-radius:4px; font-size:0.9rem;" @click="WEchartsVue.widthOptions1=620">620px(default)</span>
                    <span class="cpitem cpitem-white" style="display:inline-block; margin:0px 10px 5px 0px; border:1px solid #ddd; border-radius:4px; font-size:0.9rem;" @click="WEchartsVue.widthOptions1=310">310px</span>
                </div>

                <w-echarts-vue
                    :style="`width:${WEchartsVue.widthOptions1}px; height:300px;`"
                    :options="WEchartsVue.options1"
                ></w-echarts-vue>
...
import WEchartsVue from './components/WEchartsVue.vue'
