...
function writeHtml(v) {
    ...
    function getAppTmp() {
        ...
        //於bk前插入, 添加組件kbname
        $('div.bk').before(`<div class="head1"><span style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('//yuda-lyu.github.io/w-echarts-vue/examples/app.html?cmp='+this.innerText,'_blank')">${v.kbname}</span></div>`)
    ...
    let opt = {
        ...
        <!-- w-echarts-vue -->
        <script src="../dist/w-echarts-vue.umd.js"></script>
        ...
        appTmp: getAppTmp(),
        installVue: `Vue.component('w-echarts-vue', window['w-echarts-vue'])`,
        data: v.data,
        mounted: v.mounted,
        computed: v.computed,
        methods: v.methods,
